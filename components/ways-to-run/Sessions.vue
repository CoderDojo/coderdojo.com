<template>
  <div class="c-sessions" id="in-person">
    ...
    <div class="c-sessions__cta">
      <p><a class="c-button c-button--orange" href="https://help.coderdojo.com/cdkb/s/article/Planning-in-person-sessions-with-Covid-19-safety-measures-in-place" data-action="click" data-label="Guidance on in-person sessions" data-category="Ways to Run Downloads">Guidance on in-person sessions</a></p>
    </div>
