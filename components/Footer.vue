      ...
      <div class="c-footer__row">
        ...
        <div class="c-footer__side--right">
          ...
          <span class="c-footer__side-lang">
            ...
            <a href="https://help.coderdojo.com/cdkb/s/article/Help-CoderDojo-with-translation" class="c-footer__side-lang-translate">{{ $t('Help us with translations') }}</a>
          </span>
        </div>
      </div>
      <div class="c-footer__row">
        ...
        <div class="c-footer__links">
          ...
          <a href="/reporting-governance">{{ $t('Governance') }}</a>
