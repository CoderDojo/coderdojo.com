<template>
  <div class="c-testimonials">
    <h1 class="c-testimonials__header center-text">{{ $t('Dojos are relaxed and fun programming clubs!') }}</h1>
    ...
    <div class="c-testimonials__cta">
      <a href="#" class="c-button c-button--teal c-button--search">{{ $t('Find a Dojo to attend') }}</a>
    </div>
  </div>
</template>
