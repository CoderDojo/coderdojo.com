<template>
  <div class="c-hero center-text">
    ...
    <h3 class="c-hero__header2">{{ $t('{youth} young people are being creative with technology with the help of {volunteers} volunteers in {countries} countries. Join us!', { countries: numOfCountries, youth: '58,000', volunteers: '12,000' }) }}</h3>
