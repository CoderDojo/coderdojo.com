<template>
  <div class="c-hero center-text">
    ...
    <h2 class="c-hero__header2">{{ $t('70,000 young people are being creative with technology with the help of 240,000 volunteers in {countries} countries. Join us!', { countries: numOfCountries }) }}</h2>
